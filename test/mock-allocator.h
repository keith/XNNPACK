...
class MockAllocator : public xnn_allocator {
 public:
  MockAllocator() {
    ...
    ON_CALL(*this, allocate).WillByDefault([this](void* context, size_t size) {
...
void SetUpMockAllocator(MockAllocator* mock_allocator) {
...
void RestoreDefaultAllocator(MockAllocator* mock_allocator) {
